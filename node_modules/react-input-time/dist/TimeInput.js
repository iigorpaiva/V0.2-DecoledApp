...
function (_PureComponent) {
  ...
  function TimeInput() {
    ...
    _defineProperty(_assertThisInitialized(_this), "handleChange", function (event) {
      ...
      if (newValue === value || !(0, _isValid.default)(newValue)) {
        return;
      }
  ...
  _createClass(TimeInput, [{
    ...
    value: function render() {
      ...
      var _this$props = this.props,
          ...
          props = _objectWithoutProperties(_this$props, ["initialTime", "input"]);

      var value = this.state.value;

      if (input) {
        return _react.default.cloneElement(input, _objectSpread({}, props, {
...
TimeInput.propTypes = {
  initialTime: _propTypes.default.string.isRequired,
